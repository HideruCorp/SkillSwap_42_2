...
import type { Exchange, Category, Subcategory } from '@shared/types';
import { SkillTagUI } from '@shared/ui/skill-tag';
import Button from '@shared/ui/button/Button';
import { formatRelativeDate, calculateAge, getAgeSuffix, getDaysLabel } from '@shared/lib/date';
      ...
      <section className={styles.userSection}>
        ...
        {!isArchived && (
          <p className={styles.dateBadge}>
            Обмен начат: <span>{relativeCreatedDate}</span>
          </p>
        )}
      ...
      <section className={styles.contentSection}>
        <div className={styles.skillInfo}>
          ...
          <p className={styles.skillCategory}>
            {mySkillData.categoryName} / {mySkillData.subcategoryName}
          </p>
        </div>
        ...
        <div className={styles.exchangeSection}>
          ...
          />
          <p className={styles.skillCategory}>
            {partnerSkillData.categoryName} / {partnerSkillData.subcategoryName}
          </p>
        </div>
