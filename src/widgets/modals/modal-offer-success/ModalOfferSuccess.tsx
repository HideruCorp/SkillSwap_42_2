...
import styles from './modal-offer-success.module.scss';

interface ModalOfferSuccessProps {
  onClose: () => void;
}

function ModalOfferSuccess({ onClose }: ModalOfferSuccessProps) {
  return (
...
export default ModalOfferSuccess;
